...
LABS=("BinaryTrees" "BreadthFirstSearch" "CVXOPT_Intro" "Exceptions_FileIO" "FourierTransform" "GradientMethods" "InteriorPoint_Linear" "InteriorPoint_Quadratic" "LinkedLists" "MarkovChains" "NearestNeighbor" "PolynomialInterpolation" "QuasiNewtonMethods" "SQL1" "SQL2" "Simplex" "Wavelets")
